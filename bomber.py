...
y='\033[1;33m'
w='\033[1;37m'
printLow(f'\n  \033[1;31m    /---> \033[32;1mTACKLORIX BOMB \n\n    \033[1;31m/-----> \033[32;1mBOMB SLOWE \n\n\n')
def Vip(phone, Time):
...
while True:
    phone = is_phone(input(f'{g}  /---> {y}Enter phone number target {g}( Without +98 ) {y}: {w}'))
    if phone:
        break
try:
    Time = float(input(f'\n{g}/---> {y}Enter Time Between {g}( 2 second ) {y}: {w}'))
except ValueError:
    Time = 0.2
