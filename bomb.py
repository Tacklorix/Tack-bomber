...
y='\033[1;33m'
w='\033[1;37m'
printLow(f'\n  \033[1;37m    /---> \033[1;33mTACKLORIX BOMB \n\n    \033[1;37m/-----> \033[1;33mBOMB SLOWE \n\n\n')
def Vip(phone, Time):
...
while True:
    phone = is_phone(input(f'{w}  /---> {g}Enter phone number target {w}( Without +98 ) {g}: {w}'))
    if phone:
        break
try:
    Time = float(input(f'\n{w}/---> {g}Enter Time Between {w}(  Defult 2 second ) {g}: {w}'))
except ValueError:
    Time = 0.2
